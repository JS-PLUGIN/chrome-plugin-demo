...
chrome.contextMenus.create({
    ...
    onclick: function(){
        ...
        //     type: 'basic',
        //     iconUrl: 'img/github_512.png',
        //     title: '这是标题',
        //     message: '您刚才点击了自定义右键菜单！'
        // });
        chrome.tabs.create({url: 'https://github.com/EstherLacan/jiangfw/wiki'});
    }
});
...
chrome.webRequest.onBeforeRequest.addListener(details => {
            ...
            debugger;
    console.log("web请求监听:"+JSON.stringify(details));
    // debugger;
    // cancel 表示取消本次请求
    ...
    if(details.type == 'media') {
        chrome.notifications.create(null, {
            type: 'basic',
            iconUrl: 'img/chrome_plugin_256.png',
            title: '检测到音视频',
...
chrome.webRequest.onCompleted.addListener(
      function(details) {
        if(details.type == 'main_frame'){
            debugger;
            var patt = /https:\/\/github\.com\/.*\/.*\/blob\/.*/;
            var res=patt.test(details.url);
            console.log(details);
        }
      },
    {urls: ["<all_urls>"]},
